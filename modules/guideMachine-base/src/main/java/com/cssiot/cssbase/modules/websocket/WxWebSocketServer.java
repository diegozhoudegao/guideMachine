...
public class WxWebSocketServer {
	...
	private static CopyOnWriteArraySet<WxWebSocketServer> webSocketSet = new CopyOnWriteArraySet<WxWebSocketServer>();
	// user
	...
	public static void sendMessageTo(String message, String userCode) throws IOException {
		for (WxWebSocketServer item : webSocketSet) {
